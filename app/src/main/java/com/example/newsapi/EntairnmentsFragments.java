...
public class EntairnmentsFragments extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate (R.layout.entairtennment,null);
        recyclerViewOfEnt = view.findViewById (R.id.entairnmentfrag);
